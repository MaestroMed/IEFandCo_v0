...
export interface ContactCTAClientProps {
  bgImageUrl?: string;
  bgImageAlt?: string;
  bgOpacity?: number;
...
export function ContactCTAClient({
  ...
  return (
    <section className="section-forge-dark relative overflow-hidden py-32 md:py-44">
      {/* Optional background image (BO-driven via getPageHero("home-cta")) */}
      {bgImageUrl && (
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div
            ...
            style={{
              background: `radial-gradient(ellipse 80% 70% at 50% 50%, rgba(5,5,8,${centerAlpha}) 0%, rgba(5,5,8,0.92) 100%)`,
            }}
          />
        </div>
      )}
