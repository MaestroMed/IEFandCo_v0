...
export function TestimonialsClient({
  ...
  return (
    <section className="section-forge-warm relative overflow-hidden py-28 md:py-36">
      {/* Optional background image (BO-driven via getPageHero("home-testimonials")) */}
      {bgImageUrl && (
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div
            ...
            style={{
              background: `radial-gradient(ellipse 80% 70% at 50% 50%, rgba(255,252,245,${centerAlpha}) 0%, rgba(40,28,18,0.55) 100%)`,
            }}
          />
        </div>
      )}
